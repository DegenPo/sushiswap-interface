  ...
  return (
    <Container id="bar-page" className="py-4 mx-auto md:py-8 lg:py-12" maxWidth="full">
      <NextSeo
        ...
        openGraph={{
          images: [{ url: 'https://raw.githubusercontent.com/DegenPo/sushiswap-interface/master/public/images/ichiban/xIchibanSign.svg' }],
      ...
      <div className="flex flex-col w-full min-h-full">
        <div className="flex justify-center mb-6">
          ...
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image
              src="https://raw.githubusercontent.com/DegenPo/sushiswap-interface/master/public/images/ichiban/xIchibanSign.svg"
              alt="xICHI sign"
              width="150%"
              height="200%"
              layout="responsive"
              ...
              <div className="flex flex-wrap">
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    <Image
                      ...
                      src="https://raw.githubusercontent.com/DegenPo/sushiswap-interface/master/public/images/ichiban/xIchibanTokenLogo.svg"
                      alt="xICHI"
                      width={64}
                      height={64}
                    />
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    <Image
                      className="max-w-10 md:max-w-16 -ml-1 mr-1 md:mr-2 -mb-1.5 rounded"
                      src="https://raw.githubusercontent.com/DegenPo/sushiswap-interface/master/public/images/ichiban/IchibanTokenLogo.svg"
                      alt="ICHI"
                      width={64}
                      height={64}
                    />
